...
import { faPenToSquare, faTrashAlt } from "@fortawesome/free-solid-svg-icons"; // Corrected faTrashCan to faTrashAlt
    ...
    <div className="flex mt-[5px] ">
      <div className="flex flex-col mt-[20px] w-[180px] h-[220px] bg-[#FBFBFB] rounded-lg shadow-xl items-center space-y-1 py-3 relative">
        <div className="flex flex-col w-16 h-16 relative overflow-hidden rounded-full mt-[15px]">
          <img src="src/assets/imgGuru.jpg" alt={name} className="w-full h-full rounded-full shadow-md"/> 
        </div>
        ...
        <button className='absolute top-2 right-3 text-[20px]'><FontAwesomeIcon icon={faTrashAlt} style={{color: "#6a6d76"}} /></button> 
      </div>
    </div>
  );
};
