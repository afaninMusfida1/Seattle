...
const HalamanSiswa = () => {
    ...
    function handleChangeRekap() {
        navigate('siswa-rekap');
        console.log('pindah halaman rekap');
    }
        ...
        <div className="bg-white h-screen">
            <div className="pt-[50px] flex-col max-w-fit mx-auto">
                ...
                <div className="flex gap-6 py-[20px]">
                    ...
                    <button onClick={handleChangeRekap} className="grow py-[20px] rounded-[10px] bg-[#DA9053] font-poppins font-semibold text-left text-white px-[20px]">Rekap</button>
                </div>
            </div>
        </div>
    );
