    ...
    return (
        <div className="bg-white w-[940px] h-[400px] rounded-[10px] ml-[300px] mt-28 flex p-8 ">
            <div>
                ...
                <button className="w-[400px] h-[40px] mt-[80px] font-poppins text-[16px] border-2 bg-[#07CCB5] text-white rounded-[10px] outline-none ">Tambahkan</button>
            </div>
            <div>
                ...
                <a href="" className="text-[#078DCC] text-[14px] ml-[300px] mt-[500px] hover:underline">Lihat data siswa</a>
                </div>
            </div>
